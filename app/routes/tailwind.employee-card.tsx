  ...
  return (
    <main className="py-16 min-h-screen flex items-center justify-center">
      <div>
        ...
        <div className="bg-gray-400 mb-8 p-8 rounded border border-gray-400 max-w-xl mx-auto shadow-2xl">
        ...
        <div className="bg-gray-400 p-8 rounded border border-gray-400 max-w-xl mb-4 mx-auto shadow-2xl">
          <EmployeeCard />
        </div>
      </div>
    </main>
